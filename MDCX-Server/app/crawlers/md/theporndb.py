...
from app.crawlers.md import theporndb_movies
...
async def main(
    ...
    **kwargs,
    ...
    # Switch.THEPORNDB_NO_HASH 在此环境不可用,默认禁用哈希搜索(仅按番号搜索)
    theporndb_no_hash = True
...
@register_crawler
class ThePornDBCrawler(LegacyCrawlerAdapter):
    """ThePornDB 爬虫"""
