...
@register_crawler
class AiRavCCCrawler(LegacyCrawlerAdapter):
    """AiRav CC 爬虫"""

    name = "airav_cc"
    display_name = "AiRav CC"
    base_url = "https://airav.cc"

    priority = CrawlerPriority.NORMAL
    supported_types = ['jav']
    supported_prefixes = []
    description = "AiRav CC 中文源"
    language = "zh"
