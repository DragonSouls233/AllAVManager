...
@register_crawler
class HSCangkuCrawler(LegacyCrawlerAdapter):
    """HSCangku 爬虫"""

    name = "hscangku"
    display_name = "HSCangku"
    base_url = "https://hscangku.com"

    priority = CrawlerPriority.LOW
    supported_types = ['jav']
    supported_prefixes = []
    description = "HSCangku"
    language = "zh"
