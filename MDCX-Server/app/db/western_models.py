...
MovieActor.movie = _rel(WesternMovie, foreign_keys=[MovieActor.movie_id], back_populates="actors_rel")
...
# --- Movie → 关联表 ---
WesternMovie.actors_rel = _rel(MovieActor, back_populates="movie", cascade="all, delete-orphan")
