<template>
  <div class="movie-detail" v-loading="loading">
    <div class="detail-header">
      <el-button text @click="goBack"><el-icon><ArrowLeft /></el-icon> 返回无码列表</el-button>
...
import { getUncensoredMovie, scrapeUncensoredMovie, reloadUncensoredMovieNfo } from '@/api/uncensored'
...
function play() {
  ...
  router.push({ path: `/play/${route.params.id}`, query: { module: 'uncensored' } })
}
