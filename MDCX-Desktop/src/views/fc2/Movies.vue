<template>
  <div class="module-movies">
    ...
    <div class="movies-grid" v-loading="store.loading">
      <div v-for="m in store.movies" :key="m.id" class="movie-card" @click="goDetail(m.id)">
        ...
        <div class="info">
          ...
          <div class="meta">
            ...
            <el-tag v-if="m.is_mosaic" size="small" type="warning">有码</el-tag>
            <el-tag v-else-if="m.is_mosaic === false" size="small" type="success">无码</el-tag>
          </div>
      ...
      <el-empty v-if="!store.loading && !store.movies.length" description="暂无 FC2 影片，请先扫描目录" />
    </div>
