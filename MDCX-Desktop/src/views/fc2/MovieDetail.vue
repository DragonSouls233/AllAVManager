    ...
    <div v-if="movie" class="detail-content">
      ...
      <div class="info-section">
        ...
        <el-descriptions :column="2" border size="small">
          ...
          <el-descriptions-item label="卖家">{{ movie.seller_id || '-' }}</el-descriptions-item>
          ...
          <el-descriptions-item label="有码">{{ movie.is_mosaic ? '是' : movie.is_mosaic === false ? '否' : '-' }}</el-descriptions-item>
